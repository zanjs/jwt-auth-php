...
use Anla\JWTAuth\Test\Stubs\LaravelUserStub;

class JWTGuardTest extends AbstractTestCase
{
    /**
     * @var \Anla\JWTAuth\JWT|\Mockery\MockInterface
     */
    protected $jwt;
    ...
    /**
     * @var \Anla\JWTAuth\JWTGuard|\Mockery\MockInterface
     */
    protected $guard;
     ...
     * @test
     * @group laravel-5.2
     * @expectedException \Anla\JWTAuth\Exceptions\UserNotDefinedException
     */
