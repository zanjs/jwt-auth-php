...
namespace Anla\JWTAuth\Test\Providers\Storage;

use Mockery;
use Anla\JWTAuth\Test\AbstractTestCase;
use Illuminate\Contracts\Cache\Repository;
use Anla\JWTAuth\Providers\Storage\Illuminate as Storage;
...
class IlluminateTest extends AbstractTestCase
{
    ...
    /**
     * @var \Anla\JWTAuth\Providers\Storage\Illuminate
     */
    protected $storage;
    ...
    private function emulateTags()
    {
        ...
        $this->cache->shouldReceive('tags')->with('anla.jwt')->once()->andReturn(Mockery::self());
    }
