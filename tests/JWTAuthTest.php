...
{
    /**
     * @var \Mockery\MockInterface|\Anla\JWTAuth\Manager
     */
    protected $manager;

    /**
     * @var \Mockery\MockInterface|\Anla\JWTAuth\Contracts\Providers\Auth
     */
    protected $auth;

    /**
     * @var \Mockery\MockInterface|\Anla\JWTAuth\Http\Parser
     */
    protected $parser;
