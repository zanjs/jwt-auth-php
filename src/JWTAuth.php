...
{
    /**
     * @var \Anla\JWTAuth\Contracts\Providers\Auth
     */
    protected $auth;

    /**
     * @param  \Anla\JWTAuth\Manager  $manager
     * @param  \Anla\JWTAuth\Contracts\Providers\Auth  $auth
     ...
     *
     * @return \Anla\JWTAuth\Contracts\JWTSubject|false
     */
     ...
     *
     * @return \Anla\JWTAuth\Contracts\JWTSubject
     */
